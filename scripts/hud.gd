...
func _draw_player_frame(font:Font,s:float)->void:
    var p:=Rect2(Vector2(18,18)*s,Vector2(318,112)*s)
    ...
    var hp:=Rect2(p.position+Vector2(92,39)*s,Vector2(210,19)*s)
    ...
    var rage:=Rect2(p.position+Vector2(92,65)*s,Vector2(210,14)*s)
...
func _draw_minimap(font:Font,s:float)->void:
    var c:=Vector2(size.x-95*s,92*s);var r:=70*s
...
func _draw_controls(font:Font,s:float)->void:
    ...
    _skill_circle(Vector2(size.x-92*s,size.y-112*s),67*s,Color("a93625"),"ANGRIFF",font,int(13*s),0.0,s)
    _skill_circle(Vector2(size.x-225*s,size.y-82*s),57*s,Color("8a5a24"),"HIEB",font,int(13*s),game.skill1_cd,s)
    _skill_circle(Vector2(size.x-215*s,size.y-205*s),57*s,Color("72502c"),"WIRBEL",font,int(12*s),game.skill2_cd,s)
    _skill_circle(Vector2(size.x-92*s,size.y-255*s),52*s,Color("375b83"),"SPRUNG",font,int(11*s),0.0,s)
    if game.is_player_near_npc():_skill_circle(Vector2(size.x-92*s,size.y-370*s),55*s,Color("9a7625"),"REDEN",font,int(12*s),0.0,s)
